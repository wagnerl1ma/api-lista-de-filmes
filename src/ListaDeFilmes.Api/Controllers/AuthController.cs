    ...
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Registrar(RegisterUserViewModel registerUser)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return CustomResponse(await GerarJwtComClaims(user.Email));
            }
        ...
        public async Task<ActionResult> Login(LoginUserViewModel loginUser)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return CustomResponse(await GerarJwtComClaims(loginUser.Email));
            }
        ...
        private async Task<LoginResponseViewModel> GerarJwtComClaims(string email)
        {
        ...
        private string GerarJwtSimples()
        {
            var tokenHandler = new JwtSecurityTokenHandler();
            var key = Encoding.ASCII.GetBytes(_appSettings.Secret);
            var token = tokenHandler.CreateToken(new SecurityTokenDescriptor
